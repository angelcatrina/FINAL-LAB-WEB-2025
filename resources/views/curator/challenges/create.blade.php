<x-app-layout>
    <x-slot name="header">
        <h2 class="text-2xl font-bold text-gray-800">Buat Challenge Baru</h2>
    </x-slot>
    ...
    <div class="min-h-screen bg-gray-200 py-10">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-gray-100 shadow-md rounded-xl p-8">
                <form method="POST" action="{{ route('curator.challenges.store') }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3" required
                                  class="w-full rounded-md bg-gray-50 text-gray-900 border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-gray-400">{{ old('description') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="rules" id="rules" rows="3" required
                                  class="w-full rounded-md bg-gray-50 text-gray-900 border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-gray-400">{{ old('rules') }}</textarea>
                    ...
                    <div>
                        <label for="banner" class="block text-gray-700 font-medium mb-2">Banner (opsional)</label>
