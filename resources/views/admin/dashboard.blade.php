        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <a href="{{ route('admin.users.index') }}" 
                   class="relative p-6 rounded-xl bg-gray-100 shadow-md transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                ...
                <a href="{{ route('admin.categories.index') }}" 
                   class="relative p-6 rounded-xl bg-gray-700 shadow-md transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                ...
                <a href="{{ route('admin.moderation.queue') }}" 
                   class="relative p-6 rounded-xl bg-gray-800 shadow-md transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                    <div class="w-12 h-12 bg-gray-600 rounded-full flex items-center justify-center mb-4">
                ...
                <a href="{{ route('admin.statistics') }}" 
                   class="relative p-6 rounded-xl bg-gray-500 shadow-md transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                    ...
                    <h3 class="text-lg font-semibold text-gray-100 mb-2">Platform Statistics</h3>
                    <p class="text-gray-100 text-sm">Melihat data statistik platform: pengguna, karya, likes, dan laporan.</p>
                </a>
